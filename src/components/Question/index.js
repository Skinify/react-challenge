          ...
          <>
                ...
                if (awnser === correct_answer && lock === true) {
                  return (
                    <FormControlLabel
                      ...
                      label={htmlDecoderService(awnser)}
                    />
                  );
            ...
            {!lock && (
              <NextButton
                ...
                color="primary"
                onClick={() => {
                  setResult(selectedAnwser === correct_answer);
                  setLock(true);
                }}
              >
                Confirm
    ...
    if (lock === false)
      ...
      return (
        <Button
          ...
          variant="contained"
          style={{
            backgroundColor: e === correct_answer ? "#ff3434" : "#2ecc71",
          }}
          disabled={lock}
          onClick={() => {
            setResult(e === correct_answer);
