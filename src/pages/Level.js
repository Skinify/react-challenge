...
export default () => {
  ...
  const handleRadio = (e) => {
    ...
    switch (e.target.value) {
      case questionsEnum.EASY:
        return setQuestionsNumber(15);
      case questionsEnum.NORMAL:
        return setQuestionsNumber(20);
      case questionsEnum.HARD:
        return setQuestionsNumber(30);
      case questionsEnum.CUSTOM:
        return;
    }
  };
      ...
      <>
        <div>
          ...
          <FormControlLabel
            ...
            label={customValue < 2 ? "question" : "questions"}
          />
        </div>
      </>
    );
  ...
  return (
    ...
    >
      ...
      >
        <FormControlLabel
          value={questionsEnum.EASY}
          control={<Radio />}
          label={`Easy (15 questions)`}
        />
        <FormControlLabel
          value={questionsEnum.NORMAL}
          control={<Radio />}
          label={`Normal (20 questions)`}
        />
        <FormControlLabel
          value={questionsEnum.HARD}
          control={<Radio />}
          label={`Hard (30 questions)`}
        />
        <CustomLevelInput />
      </RadioGroup>
      <NextButton
